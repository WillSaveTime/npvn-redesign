...
const Faq = () => {
  ...
  return (
    <section className="py-16 container mx-auto" id="faq">
      <div className="px-8 sm:container">
        <div className="custom-container ">
          <h2
            className="text-3xl md:text-5xl font-bold text-center text-[#372580]"
            data-aos="fade-up"
          >
            FAQ's
          </h2>
          <div className="" style={{ position: "" }}>
            {accordianData.map((v, i) => (
              <div
                ...
                className=" border-b-2 text-[#372580] border-sloid pt-4 pb-0.5  transition ease-out duration-500 "
              >
                <div
                ...
                >
                  ...
                  <span className="transition ease-out duration-500 text-[#372580]">
